...
<div class="col-sm-12 text-center">
  ...
  <div style="margin: 35px auto 25px auto; width: 80%; display: flex; align-items: center; justify-content: space-between;">
    ...
    <div style="position: relative; flex-grow: 1; margin-right: 10px;">
      ...
      <i 
        class="fa fa-search" 
        style="position: absolute; top: 50%; left: 10px; transform: translateY(-50%); color: #543A14;"
      ></i>
    </div>

    <!-- Add Button -->
    <!-- Add button (redirects to BoardingHouse/AddUser) -->
      <a 
        href="<?= base_url('BoardingHouse/AddUser') ?>" 
        style="margin-left: 10px; background-color: #543A14; color: white; border: none; padding: 8px 12px; border-radius: 5px; cursor: pointer; text-decoration: none; display: inline-flex; align-items: center;"
      >
  ...
  <table class="center">
    <style>
      ...
      .center th:first-child,
      .center td:first-child {
        border-left: none;
      }

      .center th:last-child,
    ...
    <tbody id="userTable">
      <?php
        foreach ($UserInfo as $User) {
          ...
          echo '<td>';
          echo '<a href="' . base_url("BoardingHouse/EditUser/") . $User['userID'] . '" class="icon-btn"><i class="fas fa-edit"></i></a>';
          echo '<a href="' . base_url("BoardingHouse/DeleteUser/") . $User['userID'] . '" class="icon-btn"><i class="fas fa-trash-alt"></i></a>';
          echo '</td>';
          echo '</tr>';
        }
      ?>
