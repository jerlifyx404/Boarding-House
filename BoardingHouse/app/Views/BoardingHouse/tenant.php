...
<div class="col-sm-12 text-center">
  <h4><small>Tenant Information</small></h4>
  ...
  <div style="margin: 35px auto 25px auto; width: 80%; display: flex; align-items: center; justify-content: space-between;">
    ...
    <a href="<?= base_url('BoardingHouse/AddTenant') ?>" style="margin-left: 10px; background-color: #543A14; color: white; border: none; padding: 8px 12px; border-radius: 5px; cursor: pointer; text-decoration: none; display: inline-flex; align-items: center;">
    ...
    <tbody id="userTable">
      <?php foreach ($UserInfo as $User): ?>
        <tr>
          ...
          <td>
            <a class="icon-btn" title="View Tenant Info" href="<?= base_url('BoardingHouse/ViewTenant?tenantID=' . esc($User['userID'])) ?>">
              <i class="fa fa-eye"></i>
            </a>
          </td>
        </tr>
